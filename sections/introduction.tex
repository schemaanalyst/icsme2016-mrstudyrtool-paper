...
data, thereby quickly facilitating an understanding of the reduction method's trade-offs. Only after researchers
...
\begin{itemize}
  ...
  \item A tool to retrospectively study mutant reduction techniques; \mr~accepts a generalised input format, can easily
    be extended with new methods for mutant reduction, and is released as a free and open-source package in the R
