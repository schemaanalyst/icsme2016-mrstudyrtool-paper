...
wright2013efficient}. Although the presented method is general, this paper illustrates the retrospective study of
mutant reducers and the use of \mr~in the area of mutation analysis for database schemas. In addition to describing the
implementation of \mr~and overviewing results from applying it to the retrospective study of mutation analysis in the
domain of database schemas, this paper inaugurates the public release of this testing tool. In summary, the key
