...
schema has correctly specified integrity constraints is important because they ensure that only valid data
enters the database. However, little work has sought to test these integrity constraints~\cite{mcminn2016virtual}.
