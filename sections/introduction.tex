...
Since it is important to assess the quality of tests for relational database schemas, recent work has presented and
...
mutant reducers and the use of \mr~in the domain of mutation analysis for database schemas.
