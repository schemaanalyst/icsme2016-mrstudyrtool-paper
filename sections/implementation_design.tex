...
The R programming language was specifically designed to conduct empirical studies and is a powerful means to express computations~\cite{ihaka1996r}.
In R, the fundamental way to share code is via a package, which are  easy to distribute and include code, data, documentation and tests~\cite{wickham2015r}.
