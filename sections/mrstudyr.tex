...
and effectiveness of mutant reduction techniques. Table~\ref{tbl:study-data} gives an snippet of a data set analysed in
the experimental study of this paper.
