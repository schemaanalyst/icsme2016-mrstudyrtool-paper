...
This paper presents another mutant analysis: the retrospective study of mutant reduction techniques. Leverage data
collected during mutation testing (e.g., the name of an operator that produced a mutant, the kill-status of a mutant,
and timings concerning the costs of producing and analysing the mutant), this method 
