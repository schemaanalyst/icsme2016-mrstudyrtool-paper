...
% collecting generalized data from performing mutation testing on all mutants, \mr~is capable of determining efficiency
...
By accepting a generalized input format, the \mr~tool can be used in a variety of testing domains to assess the
