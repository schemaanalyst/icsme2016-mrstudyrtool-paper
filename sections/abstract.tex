\begin{abstract}
  ...
  prototype and evaluate mutant reducers without being burdened by the implementation details of mutation testing tools.
  Along with describing \mr's design and overviewing the experimental results from using it, this paper inaugurates the
