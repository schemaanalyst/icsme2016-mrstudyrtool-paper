\begin{abstract}
  ...
  from an analysis of all potential mutants. Focusing on the mutation operators and the mutants that they produce, the
  presented tool allows developers to quickly prototype and study mutant reduction techniques without being burdened by
  the implementation details of mutation testing tools.
