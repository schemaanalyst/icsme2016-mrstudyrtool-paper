...
{\bf function} analyse\_\textit{reduction\_technique\_name}($data$) \\
...
\hspace{4em} \atab {\bf let} $red \leftarrow$ select\_k\_percent \it optionally (\_per\_operator) \smallvspace \\
