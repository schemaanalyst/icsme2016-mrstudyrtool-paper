...
Email: \texttt{mccurdyc@allegheny.edu}}}
...
fail when executed against the tests \cite{gopinath2015empirical}. If a test fails that was expected to fail
...
mutant are confirmed as being detectable by the test suite \cite{gopinath2015empirical}.
...
a fault has been exploited and the mutant is considered to be killed \cite{gopinath2015empirical}.
...
Mutation score is the ratio of exposed \textit{normal} faults to the total number of \textit{normal} faults \cite{wright2013efficient}.
...
The mutation score is the percentage of 
...
constraints \cite{gopinath2015empirical}. Due to the fact that each generated
mutant needs to be run against at least, possibly many, test cases, mutation
testing requires a large number of computations \cite{gopinath2015empirical}.
