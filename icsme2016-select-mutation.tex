...
\title{\textit{msselectr}: A Comprehensive Tool for Analysing the Reduction Techniques for Mutation Analysis}
...
\section{\textit{msselectr}}
\subsection{Comprehensiveness of \textit{msselectr}}
approaches contained in the tool

\subsection{Released in a Standardised Format}
...
\subsection{Generalised Input Format / Extensibility}
